...
def test_create_trip():
    ...
    trips_repository = TripsRepository(conn)    # Criando uma instância da classe TripsRepository importada

    trips_infos = {
        "id": trip_id,    # Especifica que tomará a informação em formato de String
        "destination": "Osasco",
